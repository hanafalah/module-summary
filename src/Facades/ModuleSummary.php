...
namespace Hanafalah\ModuleSummary\Facades;
 ...
 */
class ModuleSummary extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleSummary\Contracts\ModuleSummary::class;
  }
}
